        ...
        <div className='w-full font-[Outfit] bg-[#FDEBD0] pt-12'>
            ...
            <div className='w-full py-20 px-10 flex flex-col  gap-16'>
                <div className='flex justify-center items-center flex-col gap-4'>
                    ...
                    <p className='text-center italic text-sm px-40'>At Basti Ki Pathshala Foundation, collaboration is at the heart of everything we do. Under the banner of ‘We Work Together,’ we embrace the power of unity, recognizing that real change comes from collective action. Our dedicated team, passionate volunteers, generous donors, and supportive community members all play integral roles in our mission to break the barriers of education in underserved communities. Together, we strive towards a common goal: to empower every child with the opportunity to thrive. Through shared vision, shared values, and shared effort, we pave the way for a brighter, more inclusive future for all.</p>
                </div>
            ...
            {/* what we do */}
            <div className='w-full py-20 px-10 pb-40 bg-[#7B3F61] flex flex-col items-center justify-center gap-6 '>
           ...
           <div className='brightness-100  relative z-0 h-[35vw] rounded-b-full py-20'  style={{   backgroundImage: `url('https://www.smilefoundationindia.org/blog/wp-content/uploads/2022/11/Education-in-india-1024x606-1.jpg')`,
    width: '100%',
    backgroundSize: 'cover',
    backgroundPosition: 'center' }}>
           <div className='absolute inset-0 bg-[#d7c6ac] opacity-60 rounded-b-full '></div>
  <div className='z-40 relative flex justify-center items-center w-full '><h1 className='text-shadow-xs text-center font-bold uppercase  text-5xl'>join our team</h1></div>
        <div className=' z-40 px-40 py-16 flex justify-center items-center gap-4 w-full '>
            <div className=' rounded-b-2xl pb-3 pl-6 flex flex-col gap-4 shadow-2xl shadow-[#3E2723] bg-[#7B3F61] text-[#FDEBD0] hover:-translate-y-3 -translate-y-0 transition-all ease-in'>
...
<p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsa, nulla quaerat nam assumenda sit accusantium at distinctio maiores incidunt culpa non. Labore praesentium accusamus magni tempore placeat ipsa adipisci repellendus.</p>
 <div><button className='text-[#3E2723] bg-[#FDEBD0] font-[Roboto]  font-black text-xl capitalize flex items-center italic px-3 py-2 rounded-xl' >learn more <span><TbChevronsRight /></span></button></div>
           ...
           {/* testimonials */}
           <div className='w-full h-[100vh] gap-7 px-4 py-20  flex flex-col'>
...
<div className='flex px-20 gap-7 embla__container'>
